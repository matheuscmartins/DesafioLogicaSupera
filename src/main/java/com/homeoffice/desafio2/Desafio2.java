package com.homeoffice.desafio2;
...
public class Desafio2 {
    public static void main(String[] args) {
        ...
        System.out.println("Digite um valor com centavos: (exemplo 1.00 ou 0.10)");
        ...
        else System.out.println("O valor não pode ser negativo ou igual a 0 !");
        } catch (InputMismatchException e) {
            System.out.println("É permitidos somente numeros !");
        }
        sc.close();
    }
}